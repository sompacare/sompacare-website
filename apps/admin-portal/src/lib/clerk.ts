...
export const CLERK_INIT_TIMEOUT_HELP =
  "Authentication could not start. Confirm clerk.sompacare.com DNS is verified in Clerk Dashboard → Domains, add this portal URL under Paths → Allowed redirect URLs, then redeploy.";
