...
| Sign-in card looks empty for a few seconds | Clerk is still loading — you should see disabled email/password fields and “Connecting to sign-in…”. If it stays blank past ~15s, see Clerk domain / env rows above. |
